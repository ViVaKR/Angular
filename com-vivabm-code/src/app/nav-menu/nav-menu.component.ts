...
export class NavMenuComponent implements OnInit, AfterViewInit {
  ...
  menus: IMenu[] = [
    ...
    { id: 2, title: "능선따라", url: "/ChatClient", icon: "code", param: true },
    { id: 3, title: "캠프", url: "/Doc", icon: "account_circle", param: true },
  ];

  solutions: IMenu[] = [
    { id: 1, title: "IP Infomation", url: "/IpInfo", icon: "folder", param: true },
    { id: 2, title: "Simple Shell Script Runner", url: "/CodeRunner", icon: "folder", param: true },
  ...
  ngOnInit(): void {
    ...
    // console.log('Enable Login Menu:', this.enableLoginMenu);
    // console.log("== isDevMode: == :", isDevMode());
    this.enableLoginMenu = isDevMode();
