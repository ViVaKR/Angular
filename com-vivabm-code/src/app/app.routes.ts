...
import { CodeRunnerComponent } from './utils/code-runner/code-runner.component';
import { ShellRunnerComponent } from './utils/shell-runner/shell-runner.component';
...
export const routes: Routes = [
    ...
    { path: 'SignUp', component: SignUpComponent, canActivate: [devModeGuard] },
    ...
    { path: 'CodeRunner', component: CodeRunnerComponent },
    { path: 'ShellRunner', component: ShellRunnerComponent },
