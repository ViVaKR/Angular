...
export class WriteUpdateCodeComponent implements OnInit, AfterContentChecked, AfterViewInit, OnDestroy {
  ...
  attachImage: string = '이미지 첨부 (click or drag & drop, all image format, single image)';
  attachFile: string = '파일 첨부 (clidk 10mb 이하, zip format, single file)';
  ...
  rows: number = 5;
  rowArray = [5, 10, 25, 50, 100, 200, 300, 500];
