...
import {
  ...
  SPACE,
  UP_ARROW
} from "./chunk-PCIH4WSJ.js";
import "./chunk-XIG2WKHE.js";
import {
  Directionality
} from "./chunk-VKIR7RA5.js";
...
_MatButtonToggleGroup.ɵfac = function MatButtonToggleGroup_Factory(ɵt) {
  return new (ɵt || _MatButtonToggleGroup)(ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, 8), ɵɵdirectiveInject(Directionality, 8));
};
...
_MatButtonToggle.ɵfac = function MatButtonToggle_Factory(ɵt) {
  return new (ɵt || _MatButtonToggle)(ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_GROUP, 8), ɵɵdirectiveInject(ChangeDetectorRef), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(FocusMonitor), ɵɵinjectAttribute("tabindex"), ɵɵdirectiveInject(MAT_BUTTON_TOGGLE_DEFAULT_OPTIONS, 8));
};
...
_MatButtonToggleModule.ɵfac = function MatButtonToggleModule_Factory(ɵt) {
  return new (ɵt || _MatButtonToggleModule)();
};
