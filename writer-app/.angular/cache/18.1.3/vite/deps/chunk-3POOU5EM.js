...
_HighlightLoader.ɵfac = function HighlightLoader_Factory(ɵt) {
  return new (ɵt || _HighlightLoader)();
};
...
_HighlightJS.ɵfac = function HighlightJS_Factory(ɵt) {
  return new (ɵt || _HighlightJS)();
};
...
_HighlightBase.ɵfac = function HighlightBase_Factory(ɵt) {
  return new (ɵt || _HighlightBase)();
};
...
_Highlight.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function Highlight_Factory(ɵt) {
    return (ɵHighlight_BaseFactory || (ɵHighlight_BaseFactory = ɵɵgetInheritedFactory(_Highlight)))(ɵt || _Highlight);
  };
})();
...
_HighlightAuto.ɵfac = /* @__PURE__ */ (() => {
  ...
  return function HighlightAuto_Factory(ɵt) {
    return (ɵHighlightAuto_BaseFactory || (ɵHighlightAuto_BaseFactory = ɵɵgetInheritedFactory(_HighlightAuto)))(ɵt || _HighlightAuto);
  };
})();
...
_HighlightModule.ɵfac = function HighlightModule_Factory(ɵt) {
  return new (ɵt || _HighlightModule)();
};
...
//# sourceMappingURL=chunk-3POOU5EM.js.map
