...
export class MenuService {
  ...
  private getScriptureMenus(): IMenuConfig[] {
    return [
      { id: 0, title: Paths.HomeScripture.title, url: Paths.HomeScripture.url, icon: 'home' },
      { id: 1, title: Paths.ListScripture.title, url: Paths.ListScripture.url, icon: 'list' },
      { id: 2, title: Paths.WriteScripture.title, url: Paths.WriteScripture.url, icon: 'edit', access: { requiresAuth: true } },
      { id: 3, title: Paths.ReadScripture.title, url: Paths.ReadScripture.url, icon: 'visibility' },
      { id: 4, title: Paths.EditScripture.title, url: Paths.EditScripture.url, icon: 'edit_note', access: { requiresAuth: true } },
      { id: 5, title: Paths.BackupScripture.title, url: Paths.BackupScripture.url, icon: 'backup', access: { requiresAuth: true } }
    ];
  }
  ...
  private getTranscriptionMenus(): IMenuConfig[] {
    return [
      ...
      { id: 1, title: Paths.ListTranscription.title, url: Paths.ListTranscription.url, icon: 'list' },
      { id: 2, title: Paths.WriteTranscription.title, url: Paths.WriteTranscription.url, icon: 'edit', access: { requiresAuth: true } },
      { id: 3, title: Paths.ReadTranscription.title, url: Paths.ReadTranscription.url, icon: 'visibility' },
      { id: 4, title: Paths.EditTranscription.title, url: Paths.EditTranscription.url, icon: 'edit_note', access: { requiresAuth: true } },
      { id: 5, title: Paths.BackupTranscription.title, url: Paths.BackupTranscription.url, icon: 'backup', access: { requiresAuth: true } }
    ];
  }
  ...
  */
  ...
  private filterMenus(menus: IMenuConfig[]): IMenuConfig[] {
    ...
    const user = this.userStore.currentUser(); // 직접 호출
